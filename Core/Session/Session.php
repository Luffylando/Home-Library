<?php
    ...
    final class Session {
      ...
      private $sessionData; //ovo su privremeni podaci.
      private $sessionId;
      private $sessionLife;
      ...
      private function generateSessionId(): string {
        $supported = "ABCDEFGHIJKLMNOPRSUVWXYZabcdefghijklmnoprsuvwxyz0123456789";
        $id = "";
        for($i = 0; $i<32; $i++){
      ...
      public function save() {
        $fingerprint = $this->fingerprintProvider->providerFingerprint();
        $this->sessionData->__fingerprint = $fingerprint; //dva underscora zato sto je malo verovatno da ce ovakav kljuc biti ikada unesen ili dopusten.
      ...
      public function reload() {
        ...
        $currentFingerprint = $this->fingerprintProvider->providerFingerprint();
